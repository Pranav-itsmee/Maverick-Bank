...
import com.hex.maverickbank.entity.ServiceQuery;
import com.hex.maverickbank.entity.ServiceRequest;
import com.hex.maverickbank.repository.ServiceQueryRepository;
import com.hex.maverickbank.repository.ServiceRequestRepository;
...
public class ServiceQueryController {
    ...
    public ResponseEntity<?> createServiceQuery(@RequestBody Map<String, Object> requestData) {
        try {
            ...
            logger.error("Service query creation failed: {}", e.getMessage());
