...
const BmanTransactionDetails = () => {
    ...
    const senderAccountNumber = fromAccount?.accountNumber;
    const senderName = fromAccount?.customer?.name;
    const ifscCode = fromAccount?.ifscCode;
    const branchName = fromAccount?.branch?.branchName;
        ...
        <div className="container-fluid">
            <div className="row">
                ...
                <div className="col-md-3 bman-transaction-sidebar">
                    ...
                    <a href="/login" className="bman-transaction-sidebar-menu-item" onClick={() => localStorage.clear()}>Logout</a>
                </div>
